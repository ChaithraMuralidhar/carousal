...
import { Carousel } from 'react-responsive-carousel';//referencing the package name here
import "react-responsive-carousel/lib/styles/carousel.min.css";//importing the css file 
...
<div style={styles}>
  <Carousel>
 {/* here we are pulling images using <carousal></carousal> */}
    <div>
